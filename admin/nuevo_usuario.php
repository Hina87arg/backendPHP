        ...
        <form action="noticias_nueva_guardar.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="categoria" name="categoria" required>
                    ...
                    <option value="lectorContribuidor">Lector/Contribuidor</option>
                </select>
            </div>
            <div>
            <div class="mb-3">
            ...
            <div>
                <a href="usuarios.php"class="btn btn-outline-light" id="volverUsuarios" name="volverUsuarios">VOLVER</a>
            </div>
            </div>
